...
public:
  ...
  template <typename T> void get(const std::string &param_name, T &value) {
  ...
  template <typename T> void get(const std::string &param_name, std::vector<T> &value) {
    if (params.find(param_name) == params.end()) {
      set(param_name, value);
      return;
    }
  ...
  template <typename T> void set(const std::string &param_name, const T &value) {
    std::ostringstream oss;
    oss << value;
    params[param_name] = oss.str();
  }

  template <typename T> void set(const std::string &param_name, const std::vector<T> &value) {
    std::ostringstream oss;
