...
FractalNoise::FractalNoise(int octaves, float scale, float wrap_width, float lacunarity,
                           float persistence, int64_t seed)
    : scale(scale), wrap_width(wrap_width), lacunarity(lacunarity), persistence(persistence) {
